...
set cntrparam levels discrete 0.01 ,0.1 ,0.5, 0.8, 0.9
...
do for [i=0:24] { splot sprintf('SAI_PD/S2D%0.6d.dat', i) using 1:2:3 with pm3d; pause 0.01 }
#do for [i=1:200] { splot sprintf('SAI_PD/LAMBDA/LDA%0.6d.dat', i) using 1:2:3 with pm3d; pause 0.01 }
#do for [i=1:120] { splot sprintf('SAI_PD/LAMBDA/LDA%0.6d.dat', i) using 1:2:(1/(2*$3)) with pm3d; pause 0.01}
