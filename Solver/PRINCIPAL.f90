! PROGRAMA PRINCIPAL, ONDE SE GERENCIA O FLUXO DE DESENVOLVIMENTO DO C�DIGO INVAS�O BIOL�GICA
PROGRAM PRINCIPAL

 !DECLARA��O DOS PARAMETROS GLOBAIS
...
! !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! !!!!!!!!!!!!!!!! AQUISI��O DE PAR�METROS !!!!!!!!!!!!!!!!!!!!!!!!
! !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!


 ! VAMOS CONSIDERAR UM �NICO BLOCO
 NB = 1
 
 
 OPEN(2, FILE='PARAMETROS_PP.dat',STATUS='OLD')

 READ (2,*) !DADOS DE ENTRADA PARA RESOLU��O DO PROBLEMA INVAS�O BIOL�GICA
 READ (2,*) !----------------------------------------------------------------------
 
 READ (2,*) !----------------------------------------------------------
 READ (2,*) !--------- PAR�METROS PARA A MONTAGEM DE ESQUEMAS NUM�RICOS
 READ (2,*) !----------------------------------------------------------
 ...
 READ (2,*) !---------------------------------------------
 READ (2,*) !--------- PAR�METROS GLOBAIS PARA A SIMULA��O
 READ (2,*) !---------------------------------------------
 ...
 READ (2,*) POP_C
 READ (2,*) !----------------------------------------------------------------------------------------
 READ (2,*) !--------- DOM�NIO - COMPRIMENTOS: INICIAL, FINAL E FIX/VAR (FIX = FIXO E VAR = VARIAVEL)
 READ (2,*) !----------------------------------------------------------------------------------------
 ...
 READ (2,*) !-------------------------------------------------
 READ (2,*) !--------- PAR�METROS PARA AS PROPRIEDADES F�SICAS
 READ (2,*) !-------------------------------------------------
 ...
 READ (2,*) !---------------------------------------------------
 READ (2,*) !--------- PAR�METROS PARA A MONTAGEM DO TERMO FONTE
 READ (2,*) !---------------------------------------------------
 READ (2,*) !BLOCO     F
 ...
 READ (2,*) !--------------------------------------------------------
 READ (2,*) !--------- PAR�METROS PARA A MONTAGEM DA CONDI��O INICIAL
 READ (2,*) !--------------------------------------------------------
 READ (2,*) !BLOCO     S_I
 ...
 READ (2,*) !---------------------------------------------
 READ (2,*) !--------- APLICA��O DAS CONDI��ES DE CONTORNO
 READ (2,*) !---------------------------------------------
 READ (2,*) ! BLOCO      W         E
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 ...
 ! SE A PASTA SAI_PD (SAIDAS DE DENSIDADE POPULACIONAL) EXISTE ENT�O ELA � DELETADA
...
!  
!  
!  ! C�PIA DO ARQUIVO EVOLUCAO.dat
!    
!    MANIPULA = SYSTEM('mv '//'EVOLUCAO.dat'//' SAI_PD')
! 
!  ! C�PIA DO ARQUIVO DIAGONAL_DOMINANTE.dat
!    
!    MANIPULA = SYSTEM('mv '//'DIAGONAL_DOMINANTE.dat'//' SAI_PD')
!    
!  ! C�PIA DO ARQUIVO PARAMETROS_PP.dat
!    
!    MANIPULA = SYSTEM('cp '//'PARAMETROS_PP.dat'//' SAI_PD')
!             
