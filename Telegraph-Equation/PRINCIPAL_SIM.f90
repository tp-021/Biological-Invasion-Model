...
!  CALL FUNCAO_LAMBDA(NB,DADOS_LAMBDA,OCUP,POP,POP_PAS,LAMBDA)

!  ! GAMMAX INICIAL 

!  CALL FUNCAO_GAMMA(NB,DADOS_GAMMA_X,X,Y,VEL_X)

!  ! GAMMAY INICIAL

!  CALL FUNCAO_GAMMA(NB,DADOS_GAMMA_Y,X,Y,VEL_Y)
...
!  NOMEARQ='LD000000.dat'
!  CALL GRAVACAO_S2D(NI,MJ,XS,YS,LAMBDA,NOMEARQ,T)
!  MANIPULA = SYSTEM('if test -e '//NOMEARQ//'; then mv '//NOMEARQ//' SAI_PD/LAMBDA; fi;')

!  NOMEARQ='GMX000000.dat'
!  CALL GRAVACAO_S2D(NI,MJ,XS,YS,VEL_X,NOMEARQ,T)
!  MANIPULA = SYSTEM('if test -e '//NOMEARQ//'; then mv '//NOMEARQ//' SAI_PD/GAMMAX; fi;')

!  NOMEARQ='GMY000000.dat'
!  CALL GRAVACAO_S2D(NI,MJ,XS,YS,VEL_Y,NOMEARQ,T)
